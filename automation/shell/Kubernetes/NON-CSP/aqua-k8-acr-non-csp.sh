...
read -p "Enter your Aqua username: " acrUser
# Ask Aqua hub Password.  Password will be masked
acrPassword=$(systemd-ask-password "Enter your Aqua password: ")
#read -s "Enter you docker password: " acrPassword

# Check if docker username and password are valid
while ! sudo docker login registry.aquasec.com -u $acrUser -p $acrPassword | grep "Login Succeeded"; do
# Ask for Aqua username
read -p "Please enter your Aqua username again: " acrUser
...
#kubectl create --namespace aqua secret acr-registry acr --acr-username="$acrUser" --acr-password="$acrPassword" --acr-email="poc@aqua.com" > /dev/null
#add by kashif to fix secrets problem
kubectl create --namespace aqua secret docker-registry  acr --docker-username="$acrUser" --docker-password="$acrPassword" --docker-email="poc@aqua.com" > /dev/null
