...
For deployment options and instructions, refer to the Product documentation, https://docs.aquasec.com/v{version}/platform/aqua-enforcement/microenforcer/[Micro Enforcer].
