...
_prepare_ke() {
    if `curl https://raw.githubusercontent.com/aquasecurity/deployments/6.0/orchestrators/kubernetes/manifests/aqua_csp_009_enforcer/kube_enforcer_advance/001_kube_enforcer_config.yaml -o "001_kube_enforcer_config.yaml"`; then
