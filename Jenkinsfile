                ...
                stage('Cloudformation') {
                    ...
                    steps {
                        script {
                            ...
                            def deploymentImage = docker.build("deployment-cloudformation-image", "-f Dockerfile-cloudformation --build-arg AQUA_KEY=${AQUA_KEY} --build-arg AQUA_KEY=${AQUA_SECRET} .")
