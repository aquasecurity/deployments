...
- While deploying KubeEnforcer using Aquactl, add the relevant flags as specified in the section, [Automate KubeEnforcer deployment using Aquactl](#automate-kubeenforcer-deployment-using-aquactl).
...
```SHELL
$ kubectl apply -f https://raw.githubusercontent.com/aquasecurity/deployments/6.5/enforcers/kube_enforcer/kubenetes_and_openshift/manifests/kube_enforcer_advanced_starboard/gen_ke_certs.sh
```
...
```SHELL
$ kubectl apply -f https://raw.githubusercontent.com/aquasecurity/deployments/6.5/enforcers/kube_enforcer/kubenetes_and_openshift/manifests/kube_enforcer_advanced_starboard/002_kube_enforcer_secrets.yaml
```    

**Step 3. Deploy KubeEnforcer advanced with Starboard.**

```SHELL
$ kubectl apply -f https://raw.githubusercontent.com/aquasecurity/deployments/6.5/enforcers/kube_enforcer/kubenetes_and_openshift/manifests/kube_enforcer_advanced_starboard/003_kube_enforcer_deploy.yaml
```
